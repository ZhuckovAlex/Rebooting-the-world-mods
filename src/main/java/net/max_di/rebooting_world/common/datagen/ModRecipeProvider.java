...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    List<ItemLike> WOOD = List.of(Items.OAK_LOG,
            Items.DARK_OAK_LOG,
            Items.BIRCH_LOG,
            Items.SPRUCE_LOG,
            Items.JUNGLE_LOG,
    ...
    List<ItemLike> STRIPPED_WOOD = List.of(Items.STRIPPED_OAK_LOG,
    ...
    List<ItemLike> PLANKS = List.of(Items.OAK_PLANKS,
    ...
    List<ItemLike> STAIRS = List.of(Items.OAK_STAIRS,
    ...
    List<ItemLike> SLABS = List.of(Items.OAK_SLAB,
            Items.DARK_OAK_SLAB,
            Items.BIRCH_SLAB,
            Items.SPRUCE_SLAB,
            Items.JUNGLE_SLAB,
