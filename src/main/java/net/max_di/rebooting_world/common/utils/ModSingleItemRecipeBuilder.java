package net.max_di.rebooting_world.common.utils;
...
public class ModSingleItemRecipeBuilder implements RecipeBuilder {
    ...
    public ModSingleItemRecipeBuilder(RecipeCategory p_251425_, RecipeSerializer<?> p_249762_, Ingredient p_251221_, ItemLike p_251302_, int p_250964_) {
    ...
    public static ModSingleItemRecipeBuilder sawmilling(Ingredient p_251375_, RecipeCategory p_248984_, ItemLike p_250105_, int p_249506_) {
        return new ModSingleItemRecipeBuilder(p_248984_, ModRecipes.SAWMILL_SERIALIZER.get(), p_251375_, p_250105_, p_249506_);
    }

    public ModSingleItemRecipeBuilder unlockedBy(String p_176810_, CriterionTriggerInstance p_176811_) {
        this.advancement.addCriterion(p_176810_, p_176811_);
        return this;
    }

    public ModSingleItemRecipeBuilder group(@Nullable String p_176808_) {
