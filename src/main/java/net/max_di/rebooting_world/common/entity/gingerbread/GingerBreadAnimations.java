...
public class GingerBreadAnimations {
	...
	public static final AnimationDefinition walk = AnimationDefinition.Builder.withLength(1.0F).looping()
		...
		.addAnimation("leg_l", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.25F, KeyframeAnimations.posVec(0.0F, 1.0F, -0.25F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("leg_r", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.75F, KeyframeAnimations.posVec(0.0F, 1.0F, -0.25F), AnimationChannel.Interpolations.CATMULLROM),
	...
	public static final AnimationDefinition run = AnimationDefinition.Builder.withLength(0.5F).looping()
		...
		.addAnimation("leg_l", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.25F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.15F, KeyframeAnimations.posVec(0.0F, 1.0F, -0.25F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("leg_r", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.4F, KeyframeAnimations.posVec(0.0F, 1.0F, -0.25F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.5F, KeyframeAnimations.posVec(0.0F, 0.0F, -0.5F), AnimationChannel.Interpolations.CATMULLROM)
		))
		.build();
}